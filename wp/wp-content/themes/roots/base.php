...
?>
<body <?php body_class(); ?> data-permalink="<?php echo $permalink; ?>" data-url-encoded-permalink="<?php echo urlencode($permalink); ?>" data-interviewee = "<?php echo get_the_title(); ?>" data-tweet-button="<?php echo get_home_url(); ?>/assets/img/twitter-bird-dark-bgs.png">
