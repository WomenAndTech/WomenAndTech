<ol class="curtains" ng-app="womenAndTech">
  <li class='opening'>
        ...
        <div class="span9">
          ...
          <address>
            ...
            <div class="author-info">
              <p class="author">
                An interview with
                <a target="_blank" href="https://twitter.com/sophiehe" rel="author" target="_blank" title="<Sophie He's twitter profile"> <strong>Sophie He</strong>
                </a>
              </p>
              <p class='date'>
    ...
    <div id="portrait" class="fullscreen">
      <img src="<?php echo get_home_url(); ?>/assets/img/sara-interview/Sara-Hicks-1.jpg" alt="Sara Hicks Profile"/>
    </div>
    <div class="container">
      <section class="row no-margin-bottom">
        ...
        <pull-quote>I’ve always been a tinkerer, especially when it comes to technology.</pull-quote>

        <question>As a child, did you know you were going to end up in the tech scene? What did you want to do when you were growing up?</question>
        ...
        <question>So then you probably couldn’t have imagined that you would be here doing what you’re doing today?</question>
        ...
        <question>Definitely not.</question>
  ...
  <li class='regular'>
        ...
        <div class='container'>
          <div class='info-panel' id="grace">
            <aside>
              ...
              <p class='last'>
                Sara shares her experiences of running a business, building a product and managing a team in an environment that values positivity and well-being on her website <a href="http://saralouhicks.com/" target="_blank">saralouhicks.com</a> and on <a href="https://medium.com/@saralouhicks" target="_blank">Medium</a>. Pictured here with Sara is her sweet pup Grace.
              </p>
            </aside>
          </div>
        </div>
        <img ng-src='/assets/img/sara-interview/Sara-Hicks-5.jpg'/>
        <div class='photo-credit light'>
          Photo credit: <a href="https://www.flickr.com/photos/saralouhicks/page1/" target="_blank">Sara Hicks</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <section class='row normal'>
        ...
        <question>Tell us how you got started with Geocities. I had a GeoCities site when I was, like, 8, and it was so bad. It was a fansite about the show Daria and it was only compatible with Netscape Navigator. How did you get into that? And what was it like back in the day?</question>
        ...
        <question>I remember neighborhoods.</question>
        ...
        <question>Got it. And is that kind of how you moseyed on into ecommerce?</question>
        ...
        <question>So how was transitioning to New York?</question>
  ...
  <li class='regular'>
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/sara-interview/Sara-Hicks-2.jpg'/>
      </div>
    </div>
    ...
    <div class="container">
      <section class='row normal'>
        ...
        <question>So you touched upon being a 4th generation Californian. How has growing up in California influenced your work habits and your path in life?</question>
        ...
        <question>Let’s talk more about Reaction. Disclaimer: I’m not super tech savvy. I come from a marketing background, so some of the questions I’m about to ask may be a little basic.</question>
        ...
        <question>Fools! Really?</question>
        ...
        <pull-quote>In the open-source world, there's more of a community of people empowered to create.</pull-quote>

        <question>Ecommerce is becoming an increasingly competitive market. How does Reaction differ from other key players like Big Cartel or Shopify or Magento?</question>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/sara-interview/Sara-Hicks-3.jpg'/>
        <div class='photo-credit light'>
          Photo credit: Sara Hicks
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <section class='row normal'>
        ...
        <question>So what does a typical day look like for you?</question>
 
        <answer>
          <p>I’m an early riser, so I wake up at 5am. I like to read and get exercise before the work day starts. I usually review goals for the day and for the week. Other than that, there really aren’t any typical days. I love that one day I could be writing a blog post and the next day, working on a wireframe or a product road map. My days are also typically packed with meetings, calls, and emails. I work with a distributed team, so no office yet. Because we’re such a small team at an early stage, I’m doing everything from product strategy to the fundraising to the marketing to the accounting to legal to talking to potential partners.</p>
        </answer>

        <question>Do you read The Oatmeal? Have you ever read that one strip— <a href="http://theoatmeal.com/comics/working_home" target="_blank">Why working at home is both awesome and horrible</a>? There’s a panel of a guy who works from home, and he’s completely lost all his social skills, and he’s been wearing the same outfit for like 3 days. But on the flip side, when you work at the office, your coworkers are constantly distracting you. So what are your thoughts on this? How do you manage working from home?</question>
 
        <answer>
          <p>For us it’s just as productive, if not more productive, because we don’t have the overhead or distractions of an office. With a distributed team, there are many ways we can communicate, like Slack or Google Hangouts. Having an office vs. distributed teams—it depends on the stage of the company. If things work well, we will look into an office in the future. We’ll see.</p>
        </answer>

        <pull-quote>I get a lot of inspiration from the ocean, the mountains, and the desert. Taking a walk on a beautiful day helps me be mindful.</pull-quote>

        <question>So you talked a little bit about why you love technology: the democratization of commerce, the ability for it to help the little guys succeed. Is there anything about technology that scares you?</question>
        ...
        <question>Speaking of mentors, did you have any role models that influenced you and guided you to where you are today?</question>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/sara-interview/Sara-Hicks-4.jpg'/>
        <div class='photo-credit light'>
          Photo credit: Sara Hicks
        </div>
      </div>
    ...
    <div class="container">
      <section class='row normal'>
        ...
        <question>You’re really unique in that you’ve held so many leadership roles. What are some of the challenges that you’ve faced encompassing these roles? How does that color how you see the industry? And why do you think young women are less inclined to enter technology?</question>
        ...
        <question>I feel like the issues that we see are structural. Funding is great and everything, but if you inject women into the workforce and once they get there and everything is still against their favor…</question>
        ...
        <question>And orgs like <a href="http://hackbrightacademy.com" target="_blank">HackBright</a> and <a href="http://girlsintech.meetup.com/" target="_blank">Girls in Tech</a>.</question>
 
        <answer>
          <p>Absolutely.</p>
        </answer>

        <pull-quote>Mentorship is something I would suggest to anyone–find those types of people.</pull-quote>
        ...
        <answer>
          <p>It’s important to start having conversations about these experiences with groups of women, tech or not. One of my mentors is Maria Thomas. She was the CEO of Etsy while I was there, and she’s an advisor for Reaction. She’s a great sounding board, and her career is unprecedented.</p>
        ...
        <question>What is one piece of advice that has resonated with you? The one thing you’ve come back to, time and time again?</question>
        ...
        <question>The chillness.</question>
        ...
        <question>Right. Entrepreneurship comes with this stigma. I think… aggressive, forceful, having to be “on” all the time. They’re very masculine terms.</question>
      ...
      <section class="row contains-questions">
          <question-for-next-interviewee image="sara-interview/img-square-sara.jpg" firstname-of-next-interviewee="our next interviewee">
          ...
          <div class="span8 offset3 credits-panel">
            <div class="credits">
              ...
              <p>
                ...
                <a href="https://twitter.com/sophiehe" target="_blank">Sophie He</a> and 
