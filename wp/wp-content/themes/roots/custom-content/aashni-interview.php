  ...
  <li class='opening'>
    <div class="container interview-intro">
      <header class="row">
        <div class="span9">
          ...
          <h1 class="clearfix" id="twitter-handle" data-twitter-handle="aashnisshah">
            <?php the_title() ?></h1>
          <address>
            ...
            <div class="author-info">
              <p class="author">
                An interview with
                <a target="_blank" href="https://twitter.com/CassKaiser" rel="author" target="_blank" title="<Cassie Kaiser's twitter profile"> <strong>Cassie Kaiser</strong>
                </a>
              </p>
              <p class='date'>
    ...
    <div class="container">
      <section class="row no-margin-bottom">
        ...
        <first-answer>
          <p>
          It was incredible. You experience such a different childhood to what most people expect, and a part of that experience involves the people you meet and the things you get a chance to go out and do. </p>
          </p>
        </first-answer>
