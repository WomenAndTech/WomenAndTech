<div class="container-fluid">
  <div class="span8">
    ...
    <div id="author-ivonnekn" class="author-image"></div>
...
<div id="opening">
  <img src="img/interview1-lucia-mariani-vena.jpg" alt="" />
  <div class="container-fluid">
    <span class="span6">
      <span id="left">
...
<div class="container-fluid">
  <div class="span8 new-line offset3 interview-panel">
...
Around that time, I met my husband in an Intro to HTML class. Up to that point I had been hacking and learning everything on my own so I thought let’s go to college for a bit and learn some of the practical stuff. We now have two children together. When I took my leave at U of T, I jumped into his company, Feast Interactive. He had been doing a lot of web development for different brands and I thought he should really push the social media side of things, so I started doing digital strategy for him. Now I’m taking all of my experience and applying it to this company that we’re growing together.
  ...
  <div class="offset1 span11 new-line pull-quote">
    <h2>
  ...
  <div class="span3 new-line info-panel">
    <div class="arrow"></div>
  ...
  <div id="neha-khera" class="span3 notable-person">
    <div class="arrow"></div>
    <h3>Notable Person</h3>
    <img src="img/interview1-NotablePerson-neha-khera.jpg" alt="" />
    <h4>Neha Khera</h4>
    Co-runs Girls In Tech Toronto with Lucia
...
We were seeing the same people saying the same things in conferences and we wanted to bring different people, different women to the table and give them an opportunity to showcase their work and present their ideas through Girls in Tech. It’s been about a year and we’ve had six events so far. It’s really taken off. We have a good community and it keeps getting better.
  ...
  <div class="span8 new-line offset3 interview-panel">
    ...
    <a href="http://girlsintechtoronto.com/gitdot-events/women-in-tech-whos-enrolling-and-sticking-to-it/" target="_blank">academic panel</a>
    . There’s a high dropout rate of women in STEM [Science, Technology, Engineering and Math] and we wanted to ask why this was happening so we brought in some academics who do research in the area. That drew a different crowd. We met women with a tech background who came to Canada looking for jobs and were having trouble finding something. I really didn’t know how to help them. I find it interesting that that’s happening in Toronto. It stuck with me and I haven’t addressed that yet.
  </div>
  <div id="mary-wells" class="span3 notable-person">
    <div class="arrow"></div>
    <h3>Notable Person</h3>
    <img src="img/interview1-NotablePerson-mary-wells.jpg" alt="" />
    <h4>Mary Wells</h4>
    University of Waterloo's Associate Dean, Outreach
    <div style="clear: both;"></div>
  </div>
  <!-- notable person -->
  <div class="span8 interview-panel">
  ...
  <div class="span8 new-line offset3 interview-panel">
    ...
    I think women tend to stick to certain fields like health and education because down the road the schedules are more accommodating to the life they want to have. But what I’ve learned so far is that even though I have less time because I’m a mom and I have two kids to take care of, I have chunks of time where I can be efficient and get things done. You have to be very focused. That’s a certain mindset you have to learn. One of two things happens: you either become overwhelmed or you become very efficient.
  </div>
  <div class="span8 new-line offset3 interview-panel">
  ...
  <div class="span11 new-line pull-quote">
    <h2>
  ...
  <div id="william-barek" class="span3 notable-person">
    <div class="arrow"></div>
    <h3>Notable Person</h3>
    <img src="img/interview1-NotablePerson-william-barek.jpg" alt="" />
    <h4>William Barek</h4>
...
How have you been able to balance your career goals and your personal life?
    ...
    I’m still trying to figure it out, it’s tough. I think working with my husband in our business will be a lot easier to manage than working the nine to five. Right now I can put in my time at different points when I’m most efficient. I can put my kids to bed and work another three hours. When you’re sharing a business with someone else you’re both tapped in and you can plug in at any time.
...
There needs to be a lot more co-working. I think that would help. If you feel like you can bring your child somewhere and still do what needs to be done, I think that would be helpful to women.
  ...
  <div class="span8 offset3 new-line">
...
With Feast Interactive, we’re filling a void. A lot of companies don’t want to manage social media marketing, they don’t know how, and we’re helping them with that. Right now, we’re working with a lot of startup brands in Canada which is really great because when they grow, we grow with them. We’re working with companies who believe in organic growth and doing it in an honest and real way. It’s been really exciting to be along for the ride.
  ...
  <div class="span8 new-line offset3 interview-panel">
    <h3>Choose one from each of the following:</h3> <strong>cats or dogs?</strong>
    dogs <strong>children or elders?</strong>
    children
    <strong>desktop or mobile?</strong>
    mobile
    <strong>Google or Apple?</strong>
    Google
    <strong>work or play?</strong>
    work
    <strong>Daphne or Velma?</strong>
    Velma
    <strong>local or global?</strong>
    global
    <strong>realism or surrealism?</strong>
    surrealism
    <strong>open source or proprietary?</strong>
    open source
  ...
  <div class="span8 new-line offset3 interview-panel">
    ...
    When will we see a female version of <em>Steve Jobs</em>
    or <em>Mark Zuckerberg</em>
    ?
  </div>
</div>
