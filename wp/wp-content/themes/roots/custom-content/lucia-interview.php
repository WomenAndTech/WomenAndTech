...
<li>
  ...
  <div id="portrait" class="fullscreen"><img src="<?php echo get_home_url(); ?>/assets/img/lucia-interview/lucia-mariani-vena-large.jpg" /></div>
  ...
  <div class="container">
    ...
    <section class="row">
      ...
      <div class="span7 interview-panel">
        ...
        <p>Mary Wells who is at the University of Waterloo – she’s an engineer, a mom and a really impressive woman. Her thesis is that you really have to get to children when they’re young, like grade 4 or 5 to get them interested in the sciences and math. After that, it’s a bit too late. That’s her philosophy.</p>
      </div>
    </section>
    <section class="row">
      <div class="span7 offset4 interview-panel">
        <h3>Do you think that the structure of these programs need to change?</h3>
...
<li>
  ...
  <div class="container">
    ...
    <section class="row">
      ...
      <div class="span7 interview-panel">
        <h3>Anne-Marie Slaughter’s <a href="http://www.theatlantic.com/magazine/archive/2012/07/why-women-still-cant-have-it-all/309020/" title="Online version of the article Why Women Still Can't Have It All by Anne-Marie Slaughter in the Atlantic Magazine">article in The Atlantic</a> talks about how difficult it is for women to “have it all”. How have you been able to balance your career goals and your personal life?</h3>
...
<li>
  ...
  <div class="container">
    <section class="row">
      <div class="span7 offset4 interview-panel">
        <h3>Did having a family change your perspective on the industry or the role of women working in the industry?</h3>
      ...
      <div class="span11 pull-quote">
        <aside class="quote">
          <h2>Showing up in client meetings and pitches you’re wondering, are they not going to accept us because I’m pregnant?</h2>
        </aside>
        <div class="quote-mark"><img src="<?php echo get_home_url(); ?>/assets/img/quote-mark.png" /></div>
      </div>
      <div class="span7 offset4  interview-panel">
    ...
    <section class="row">
      ...
      <div class="span7 interview-panel">
        <h3>Maybe there needs to be less talk about having it all and more doing?</h3>
