  ...
  <li class='opening'>
        ...
        <div class="span9">
          ...
          <address>
            ...
            <div class="author-info">
              <p class="author">
                An interview with
                <a target="_blank" href="https://twitter.com/cassiemc" rel="author" target="_blank" title="<Cassie McDaniel's twitter profile"> <strong>Cassie McDaniel</strong>
                </a>
              </p>
              <p class='date'>
    ...
    <div class="container">
      <section class="row no-margin-bottom">
        ...
        <first-question>
          I am curious to know how you got your name? 
        </first-question>

        <first-answer>
          <p>
          Let’s see. Oh God. My name. My father was raised by his stepfather, whose last name was Mitchell, from the time my dad was ten or so. My parents thought it would be a nice way to recognize him, so they would call me Mitchell Baker. Then my mom says at the last minute, “Oh, if it’s a girl, maybe she should have a feminine name.” So my first name, Winifred, is my grandmother’s name, whom I never met nor do I know anything about.          </p>
          </p>
          <p>
          My mom was eccentric. She was exceedingly eccentric. Sometimes you know in a way that was really endearing and charming and sometimes in a way I would look at her and think, “Wow, that’s really out there.”
          </p>
          <p>
  ...
  <li class='regular'>
        ...
        <div class='container'>
          <div class='info-panel' id="press">
            <aside>
              ...
              <h3> </h3>
              <p class='last'>
                In 2005, <i>Time</i> magazine named Baker one of the 100 most influential people in the world. In 2012, along with Tim Berners Lee, she became an inaugural inductee into the <a href="http://www.internethalloffame.org/" target="_blank">Internet Hall of Fame</a>.
              </p>
            </aside>
          </div>
        </div>
    ...
    <div class="container">
      <section class='row normal'>
        ...
        <question>
        Asian Studies was an unusual area of study when you were in school. Is your life what you thought it would turn out to be?
        </question>
        ...
        <pull-quote>
          I just look at the options in front of me and walk the most interesting path.
        </pull-quote>

        <question>
          Can you tell me about your parents and what they did? Why was your mom eccentric?
        </question>
  ...
  <li class='regular'>
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/mitchell-interview/mitchell-02b-kitchen-Joi-Ito.jpg'/>
        <div class='photo-credit light'>
          Photo credit:  <a href="https://www.flickr.com/photos/joi/3114659015" target="_blank">Joi Ito</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <section class='row normal'>
        ...
        <callout-with-large-image image="mitchell-interview/mitchell-callout-baker-art-foundry.jpg" alternative-text-for-image="Baker Art Foundry">
               <p>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/mitchell-interview/mitchell-08-speaking-Hubert-Figuiere.jpg'/>
        <div class='photo-credit light'>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/mitchell-interview/mitchell-03alt-board-Flore-Allemandou-WoMoz.jpg'/>
        <div class='photo-credit light'>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/mitchell-interview/mitchell-04-travel-Joi-Ito.jpg'/>
        <div class='photo-credit light'>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/mitchell-interview/mitchell-05-leading-OnInnovation.jpg'/>
        <div class='photo-credit light'>
  ...
  <li class='regular'>
    ...
    <div class='fullscreen'>
      <div class='parallax'>
        ...
        <img ng-src='/assets/img/mitchell-interview/mitchell-06-network-Doug-Belshaw.jpg'/>
        <div class='photo-credit light'>
        ...
        <div class='container'>
          <div class='info-panel' id="trapeze">
            <aside>
              ...
              <h3></h3>
              <p class='last'>
                Trapeze became a part of Baker’s life in 2001. She has written about fun, fear, challenges and injuries on her blog, <a href="http://blog.lizardwrangler.com/" target="_blank">Lizard Wrangling.</a>
              </p>
            </aside>
          </div>
        </div>
        <img ng-src='/assets/img/mitchell-interview/mitchell-07-fear-badubadu-trapeze.jpg'/>
        <div class='photo-credit light'>
        ...
        <div class='container'>
          <div class='info-panel' id="office">
            <aside>
              ...
              <h3></h3>
              <p class='last'>
                Mozilla has twelve offices, hundreds of remote employees, and hundreds of other volunteer communities around the world. Instrumental in shaping Mozilla’s open source culture, Baker continues to champion the idea of <a href="https://commonspace.wordpress.com/2014/12/18/davidgoliathempire/" target="_blank">radical participation.</a>
              </p>
            </aside>
          </div>
        </div>
        <img ng-src='/assets/img/mitchell-interview/mitchell-03-women-OnInnovation-4.jpg'/>
        <div class='photo-credit light'>
