...
<li>
  <div class="container interview-intro">
    <header class="row">
      <div class="span9">
        ...
        <h1 class="clearfix" id="twitter-handle" data-twitter-handle="@heatherpayne"><?php the_title(); ?></h1>
        <address>
  ...
  <div class="container">
    ...
    <section class="row">
      <div class="span7 offset4 interview-panel">
        ...
        <p>But, I would say when I started learning I was at a 1. I've moved up to probably a 5 in front-end, and back-end I'm probably up to a 2. In my entrepreneur skills, I was at a zero before. I still have a long way to go but I think I'm a better entrepreneur than a front-end coder. Maybe a 7.</p>
      </div>
    </section>
  ...
  <div class="container">
    <section class="row">      
      <div class="span7 offset4 interview-panel">
        ...
        <p>I wouldn't go around calling myself a ‘woman in tech,’ I guess because I don't want to offend the people who have a narrower definition of the term. Some say you're a woman in tech if you're in a core tech role, if you're writing code as your job. A lot of those women are mentors and volunteers for Ladies Learning Code. We do need them to call themselves women in tech and stand up as role models, and I’m glad so many of them are willing to do that.</p>
      </div>

      <div class="span11 pull-quote">
        <aside class="quote">
          <h2>I hope my own reluctance to call myself a woman in tech goes away because we need [...] 9-year-olds to see there are a lot of different ways to have a career in technology.</h2>
        </aside>
        <div class="quote-mark"><img src="<?php echo get_home_url(); ?>/assets/img/quote-mark.png" /></div>
      </div>
    </section>
    ...
    <section class="row">
      <div class="span 7 offset4 interview-panel">
        <p>What I hope is that over time, over the next few years, those of us not in core tech roles become less reluctant to call ourselves women in tech, people – like myself – who are not writing code every single day as my job, but who still have an important role in the technology industry. When it comes to tech, I'm definitely pushing the limit and moving things forward as an integral part of what I do.</p>

        <p>I hope that my own reluctance to call myself a woman in tech goes away because we need more examples in general. We need 9-year-olds to see that there are a lot of different ways to have a career in technology.</p>
      </div>
    </section>
    ...
    <section class="row">
      <div class="span7 offset4 interview-panel">
        ...
        <p>We aim for 50/50 both in terms of the lead instructors and the mentors (who are like assistant instructors). We made that specific decision, because what we're looking for in the real world is not for women to be 100% of the tech industry, we just want balance. Having that reflected in our own learning environment is really important.</p>
      </div>
    </section>
  ...
  <div class="container">
    ...
    <section class="row">
      <div class="span7 offset4 interview-panel">
        ...
        <p>There are a lot of success stories where people come to a workshop and then go on to launch a website because they learned how to do it at Ladies Learning Code. <a href="http://ladieslearningcode.com/2012/12/ladies-learning-code-success-story-emma-jenkin/" target="_blank">Emma Jenkin</a> has made really awesome progress since her first Ladies Learning Code workshop.</p>
        <p>I recently heard about one of our regulars at Girls Learning Code – she had to write a book report for school and instead of creating a Word document, she built a website and sent her teacher the link. Isn’t that the coolest ever?</p>      
      </div>
    </section>
    ...
    <section class="row">
      <div class="span7 offset4 interview-panel">
        ...
        <p>I only realized that Women in Tech groups are <a href="http://www.huffingtonpost.ca/2012/04/26/ladies-learning-code_n_1456673.html#comments" target="_blank">a little bit controversial</a> when Ladies Learning Code first started. All I saw was that this could be positive. I had no idea that people see groups like ours as polarizing, that creating a separate group for a specific group actually has a negative impact.</p>
      </div>
      <div class="span11 pull-quote">
        <aside class="quote">
          <h2>Will we be around forever? No. I think once the industry is more equal, we’ll stop having the need for groups like Ladies Learning Code.</h2>
        </aside>
        <div class="quote-mark"><img src="<?php echo get_home_url(); ?>/assets/img/quote-mark.png" /></div>
      </div>
      <div class="span7 offset4 interview-panel">
  ...
  <div class="container">
    ...
    <section class="row">      
      <div class="span7 offset4 interview-panel">
        <p>I do have some wonderful mentors helping me with Ladies Learning Code and HackerYou who are willing to let me talk their ear off and find out their thoughts on where we should go next. One of my favourites is <a href="https://twitter.com/aprildunford" title="April Dunford's twitter profile" target="_blank">April Dunford</a>, who you should definitely interview. She is an amazing marketer, a really savvy business person and she’s just such a fabulous woman. She and I have met up a few times in the past couple of months and every time I leave one of those conversations I have so much hope and excitement for the future.</p>
      </div>
    </section>
    ...
    <section class="row">
      ...
      <div class="span7 interview-panel">
        ...
        <p>Success to me is two things – I’m driven by a desire to be a role model to women and girls. I did <a href="http://www.strengthsfinder.com/" target="_blank">“StrengthsFinder 2.0”</a> and my top strength was “Includer”. I don’t like seeing a group of people excluded from anything. Because I’m a woman, I’m especially sensitive to women’s issues. If I’m doing something to move the needle when it comes to empowering an underrepresented group, I feel like that’s success.</p>
        <p>The second thing, in the short-term, is having a cool life where I feel excited every day about my mission. The fact that <a href="http://hackeryou.com/guest-post-my-time-at-hackeryou/" target="_blank">people actually like HackerYou</a> is so exciting to me. With Ladies Learning Code, it’s already a success; now we’re pushing forward and managing risks, creating a space and expanding to new cities.</p>
      </div>
    </section>
    ...
    <section class="row">
      ...
      <div class="span7 offset4 interview-panel">
        ...
        <p>I think I’d be using the same skills – community building, bringing new ideas into reality. I think I’d have a different skill-building club. Something like a woodworking club or a knitting club. Something an Internet-less society would need more of.</p>
      </div>
    </section>
