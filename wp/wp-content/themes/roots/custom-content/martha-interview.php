...
<li>
    ...
    <div id="portrait" class="fullscreen">
      ...
      <div class="photo-credit light">
        Photo credit:
        <a href="http://rosabourin.crevado.com/" target="_blank">David "Kid With Camera" Waldman</a>
      </div>
    </div>
    <div class="container">
      <section class="row">
      ...
      <section class="row clearfix">
        ...
        <div class="span11 pull-quote">
          <aside class="quote">
            <h2>Sometimes you have to fail really big to actually understand what you need to learn, and how to do that quickly, so that the next time you're prepared and ready to take a more qualified risk.</h2>
          </aside>
          <div class="quote-mark"><img src="<?php echo get_home_url(); ?>/assets/img/quote-mark.png" /></div>
        </div>
        <div class="span7 offset4 interview-panel">
    ...
    <div class="container">
      ...
      <section class="row">
        <div class="span7 offset4 interview-panel">
          ...
          <p>You know what, [laughs] the first video games only began to appear once I was grown up! I do remember being immediately taken by Space Invaders, the arcade game; I was addicted to it rather quickly. And it was interesting because I first played it in the UK, when I was over there with Martha and the Muffins recording our first album and we all thought, "Wow, this is fantastic!" They didn't yet have it over here so we were all trying to figure out how we could introduce Space Invaders to Canada [laughs].</p>
  ...
  <div class="container">
      <section class="row">
        ...
        <div class="span7 offset4 interview-panel">
          ...
          <p>I just thought 'this is not the way to bring up a family so I'm going to have to focus on doing stuff that's closer to home.' I decided to get out of London and moved, quite by chance, to the same village in the English countryside where Peter Gabriel had his Real World recording studios.</p>
          <p>I ended up going down to the studios one day to hang out with my friends in New Order, who were recording an album there. I knew everyone in the band quite well when I was working with Peter Saville (I had been involved in a lot of the work with them for Factory), and we were all sort of music business pals. I just thought “Hang on! There are things I could do here! And I need a job!” [laughs]. So I met up with Peter Gabriel and proposed that we do something together and he said “Yes!”.</p>
        </div>
      </section>
      <section class="row">
        <div class="span7 offset4 interview-panel">
...
<li>
  <div class="fullscreen">
    ...
    <div class="container">
      ...
      <section class="row">
        <div class="span7 offset4 interview-panel">
          <h3>In our last interview Dessy Daskalov asked, “How are you changing the status quo and what are you doing to change the things you don't like about the world?”</h3>
